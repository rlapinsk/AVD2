...
resource "azurerm_virtual_machine_extension" "avd_script" {
  ...
  settings = <<SETTINGS
    {
      "fileUris": [
      "https://avdstore9753.blob.core.windows.net/testcontainer/Add-WVDHostToHostpoolSpringORG4T.ps1?sp=r&st=2022-06-02T16:48:27Z&se=2022-06-23T00:48:27Z&spr=https&sv=2020-08-04&sr=b&sig=x0v5xLvNAGCH6KgsMmz1ibc3or8wohRl1ZlG3WLqYHM%3D"
      ]
    }
SETTINGS
